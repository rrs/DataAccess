...
namespace Rrs.DataAccess.DbCommand
{
    public static class SingleRowReaderExecutor
    {
        ...
        /// </summary>
        public static T Execute<T>(string commandText, IDbConnection connection, IDbTransaction transaction, Func<IDataReader, T> readerFunc, IEnumerable<SqlParameter> parameters = null, CommandType commandType = CommandType.Text)
        {
